...
public enum IssuedCouponExceptionCode implements ExceptionCode {
  ...
  ISSUED_ALREADY_USED(HttpStatus.CONFLICT, "이미 사용한 쿠폰입니다."),
  ISSUED_COUPON_EXPIRED(HttpStatus.GONE, "만료된 쿠폰입니다. "),
  ...
  OWNERSHIP_MISMATCH(HttpStatus.FORBIDDEN, "쿠폰 권한과 소유자가 일치하지 않습니다.");
